      ...
      const fetchHabits = async () => {
        try {
          const [completedRes, pendingRes] = await Promise.all([
            axios.get(`https://habit-tracking-system-proj.onrender.com/habits/completed?userId=${userData.id}`),
            axios.get(`https://habit-tracking-system-proj.onrender.com/habits/pending?userId=${userData.id}`),
          ]);
